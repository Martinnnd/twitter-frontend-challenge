...
const ProfilePage = () => {
  ...
  useEffect(() => {
    if (profileDataQuery.status === 'success') {
      console.log("✅ Datos de perfil recibidos:", profileDataQuery.data);
      setProfile({
...
//     onSuccess: () => {
//       addToast({
//         message: t("toast.delete-account"),
...
//   useEffect(() => {
//     setFollowing(followingUser.data?.some((follow: Follow) => follow.followedId === profileQuery.data?.id))
//   }, [followingUser.status, followingUser.data])
